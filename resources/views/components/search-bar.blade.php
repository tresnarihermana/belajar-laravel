            ...
            <form>
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        <label for="search"
                            class="hidden mb-2 text-sm font-medium text-gray-900">Search bar</label>
                    ...
                    <div>
                        <button type="submit"
                            class="py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg border cursor-pointer bg-blue-800 border-blue-600 sm:rounded-none sm:rounded-r-lg hover:bg-blue-100 focus:ring-4 focus:ring-blue-300">Search</button>
                    </div>
                </div>
            </form>
        </div>
