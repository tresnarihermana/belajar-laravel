  <nav class="bg-gray-800" x-data="{ isOpen: false }">
          ...
          <div class="flex h-16 items-center justify-between">
              ...
              -->
                          <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
                              ...
                              @else
                                  <a href="/submit" class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
                                      tabindex="-1" id="user-menu-item-0">Tambah Artikel</a>
              ...
              <div class="-mr-2 flex md:hidden">
                  <!-- Mobile menu button -->
                  <button type="button" @click="isOpen = !isOpen"
                      class="relative inline-flex items-center justify-center rounded-md bg-gray-800 p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset--800 focus:outline-hidden"
                      ...
                      {{-- <svg :class="{ 'block': isOpen, 'hidden':!isOpen }" fill="none" class="block" viewBox="0 0 24 24"
      ...
      <div x-show= "isOpen"class="md:hidden" id="mobile-menu">
        ...
        <a href="/contact" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Contact</a> --}}
              <x-nav-link-mobile href="/dashboard" :active="request()->is('/dashboard')">Home</x-nav-link-mobile>
          ...
          <div class="border-t border-gray-700 pt-4 pb-3">
              ...
              <div class="mt-3 space-y-1 px-2">
                  <a href="/submit"
                      class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Tambah Artikel</a>
                  <a href="/profile"
                      class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Settings</a>
                  <form method="POST" action="{{ route('logout') }}" >
                      @csrf

                      <a  class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white" href="logout"
                          onclick="event.preventDefault();
                                                this.closest('form').submit();">
                          {{ __('Log Out') }}
                  </a>
